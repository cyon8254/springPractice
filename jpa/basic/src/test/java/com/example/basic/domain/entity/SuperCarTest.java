...
//        Assertions.assertThat(superCarDAO.findSuperCarBetweenReleaseDate(startDate,endDate).get(0).getSuperCarBrand()).isEqualTo(SuperCarBrand.LAMBORGHINI);
    ...
    public void deleteTest(){
        log.info("출력 결과: "+ superCarDAO.findById(3L).get());
        superCarDAO.delete(superCarDAO.findById(3L).get());
    }

    @Test
    public void findByIdTest(){
        log.info("아이디 조회 결과: " + superCarDAO.findById(3L));
    }

    @Test
    public void findAllTest(){
        log.info("전체 차량 조회: "+ superCarDAO.findAll());
    }
    ...
    public void findSuperCarByReleaseDate(){
        log.info("차량 출시일: " + superCarDAO.findSuperCarByReleaseDate("20220425"));
    }

    @Test
    public void findSuperCarByColorContainingTest(){
        log.info("White 색 차량 조회 : " + superCarDAO.findSuperCarByColorContaining("White"));
    }
}
