...
public class PageDTO {
    ...
    private com.example.order.domain.vo.Criteria criteria;

    public void createPageDTO(com.example.order.domain.vo.Criteria criteria, int total) {
        createPageDTO(criteria, total, 10);
    }

    public void createPageDTO(com.example.order.domain.vo.Criteria criteria, int total, int pageCount) {
